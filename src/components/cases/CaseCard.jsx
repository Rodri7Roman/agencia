  ...
  return (
    ...
    >
      <div className="flex-shrink-0">
        <img id={data.id} className="h-96 w-full object-scale-down" src={data.imageUrl} alt="" />
      </div>
      <div className="flex flex-1 flex-col justify-between bg-white p-6">
        <div className="flex-1">
          ...
          <a href={data.href} className="mt-2 block">
            <p id={index} className="lg:text-4xl pt- pb-6 text-2xl transition duration-400 ease-in-out font-semibold text-gray-900">
              {data.title}
            </p>
